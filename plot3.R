...
plot(U, ylab="Energy sub metering", xlab="", type="l", xaxt='n', ylim=c(0,38));
...
legend("topright", legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"),   lty=c(1,1), lwd=c(1,1));   # Legend
dev.off(); 
